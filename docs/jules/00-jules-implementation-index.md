...
| General repository/project context | `project-context.md` and `shopify-ui-ux-project-overview.md` |
...
| Service onboarding and intake forms | `services-onboarding-forms-context.md`, `08-onboarding-app-proxy-integration.md`, `10-custom-app-backend-contract.md`, and `11-shopify-store-configuration-checklist.md` |
| Nucleus templates, documentation suites, toolkits, onboarding form links | `nucleus-onboarding-forms-context.md`, `shopify-product-template-context.md`, and `08-onboarding-app-proxy-integration.md` |
...
| Partner Offers, offer categories, offer pages, CTA URLs | `project-context.md`, `marketplace-project-overview.md`, `08-content-library-and-affiliate-links.md`, and `12-data-model-registry.md` |
| Marketplace hub, buyer/seller paths, Business-In-A-Box, asset sales | `marketplace-project-overview.md`, `project-context.md`, and `12-data-model-registry.md` |
| Membership pages, member benefits, application-first signup, member resources | `membership-section-project-context.md`, `customer-account-portal-context.md`, and `14-copy-and-conversion-rules.md` |
| Business NBN | `business-nbn-shopify-context.md`, `10-custom-app-backend-contract.md`, and `11-shopify-store-configuration-checklist.md` |
| Business Finance and Business Insurance | `business-finance-insurance-project-context.md`, `08-onboarding-app-proxy-integration.md`, and `14-copy-and-conversion-rules.md` |
| Real Estate / Property Field Services booking | `real-estate-booking-project-context.md`, `10-custom-app-backend-contract.md`, and `11-shopify-store-configuration-checklist.md` |
...
| App proxy, Custom App, Google Cloud backend integration | `08-onboarding-app-proxy-integration.md`, `10-custom-app-backend-contract.md`, and `11-shopify-store-configuration-checklist.md` |
...
4. The most specific task context file.
5. Broader project overview files.
6. Older contextual notes.
